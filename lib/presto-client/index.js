...
var Client = exports.Client = function(args){
  ...
  this.basicAuth = args.basicAuth || null;
...
Client.prototype.request = function(opts, callback) {
  ...
  if (opts instanceof Object) {
     ...
     * has specified a client.basicAuth object.
     * client.basicAuth = { user: "<user", password : "<password>"}
     */
    if (client.basicAuth)
      opts.headers[Headers.AUTHORIZATION] = 'Basic ' + new Buffer(client.basicAuth.user + ":" + client.basicAuth.password).toString("base64");
       ...
       * 2nd time
{
 ...
 "id": "20140120_032523_00000_32v8g"
      ...
      client.request(next_uri, function(error, code, response){
        ...
        if (state_callback && (last_state !== response.stats.state || client.enableVerboseStateCallback)) {
