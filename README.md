...
* opts [object]
  ...
  * basicAuth [object]
    ...
    * basicAuth: {user: "user", password: "password"} (default:null)
  * catalog [string]
  ...
  * enableVerboseStateCallback [boolean]
    ...
    * when enableVerboseStateCallback is set to `false`, the state change callback will only be called upon a change in state. 
